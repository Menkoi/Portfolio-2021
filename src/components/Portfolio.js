        ...
        <section class="page-section bg-light" id="portfolio">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Click on the images to see some cool projects ive worked on</h3>
                </div>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <p>Thanks to the pandemic impacting everyone these days Most of us are spending a lot more time stuck inside
                                       ...
                                       With Save TV you can easily find all of your favorite shows past, new or ongoing series</p>
                                    <ul class="list-inline">
                                        <li>
                                            
                                            Click below to see the source code and to view the website.
                                        </li>
                                        <li>
                                        <a href="https://github.com/UTBootCampGroup2/SaveTV" >Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://utbootcampgroup2.github.io/SaveTV/" >Live Site</a>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                        <a href="https://github.com/Menkoi/Budget-Tracker" >Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://guarded-wave-17406.herokuapp.com/" >Live Site</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                        <a href="https://github.com/project3UOT/bookend">Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://agile-mesa-10306.herokuapp.com/">Live Site</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                        <a href="https://github.com/Menkoi/password-gen" >Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://menkoi.github.io/password-gen/" >Live Site</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                        <a href="https://github.com/UTBootCampGroup2Project2/reward-bank" >Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://rocky-dawn-18669.herokuapp.com/" >Live Site</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
                            ...
                            <div class="col-lg-8">
                                <div class="modal-body">
                                    ...
                                    <ul class="list-inline">
                                        ...
                                        <li>
                                        <a href="https://github.com/Menkoi/Weather-Dashboard" >Github Repository</a>
                                        </li>
                                        <li>
                                        <a href="https://menkoi.github.io/Weather-Dashboard/" >Live Site</a>
                                        </li>
                                    </ul>
                                    <button class="btn btn-primary" data-dismiss="modal" type="button">
                                        <i class="fas fa-times mr-1"></i>
